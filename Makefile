source = util.cc binary-search.cc clopper-pearson.cc cptester.cc blyth-still-casella.cc bsctester.cc coverage-graph.cc
objects = util.o binary-search.o clopper-pearson.o blyth-still-casella.o coverage-graph.o
executables = cptester bsctester
